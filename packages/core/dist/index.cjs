...
var chunkT52WOGNY_cjs = require('./chunk-T52WOGNY.cjs');
var chunkVNLR35GO_cjs = require('./chunk-VNLR35GO.cjs');
var chunkZRCUY5U2_cjs = require('./chunk-ZRCUY5U2.cjs');
var chunkIIBRG5S5_cjs = require('./chunk-IIBRG5S5.cjs');
var chunkXZVAP6PR_cjs = require('./chunk-XZVAP6PR.cjs');
...
var chunkZ6YTQGT5_cjs = require('./chunk-Z6YTQGT5.cjs');
...
function createDatabaseToolsAdminRoutes() {
  ...
  router3.use("*", chunkZRCUY5U2_cjs.requireAuth());
...
function createOTPLoginPlugin() {
  ...
  otpAPI.post("/verify", async (c) => {
    try {
      ...
      const token = await chunkZRCUY5U2_cjs.AuthManager.generateToken(user.id, user.email, user.role);
...
adminRoutes.use("*", chunkZRCUY5U2_cjs.requireAuth());
...
function createMagicLinkAuthPlugin() {
  ...
  magicLinkRoutes.get("/verify", async (c) => {
    try {
      ...
      const jwtToken = await chunkZRCUY5U2_cjs.AuthManager.generateToken(
        user.id,
        user.email,
        user.role
      );
      chunkZRCUY5U2_cjs.AuthManager.setAuthCookie(c, jwtToken);
      await db.prepare(`
...
function renderCacheDashboard(data) {
  const pageContent = `
    ...
    ${chunkT52WOGNY_cjs.renderConfirmationDialog({
    ...
    ${chunkT52WOGNY_cjs.getConfirmationDialogScript()}
  `;
  const layoutData = {
    title: "Cache System",
...
function createSonicJSApp(config = {}) {
  ...
  const appVersion = config.version || chunkZ6YTQGT5_cjs.getCoreVersion();
  const appName = config.name || "SonicJS AI";
  app2.use("*", async (c, next) => {
    c.set("appVersion", appVersion);
    await next();
  });
  app2.use("*", chunkZRCUY5U2_cjs.metricsMiddleware());
  app2.use("*", chunkZRCUY5U2_cjs.bootstrapMiddleware(config));
  ...
  app2.route("/api", chunkT52WOGNY_cjs.api_default);
  app2.route("/api/media", chunkT52WOGNY_cjs.api_media_default);
  app2.route("/api/system", chunkT52WOGNY_cjs.api_system_default);
  app2.route("/admin/api", chunkT52WOGNY_cjs.admin_api_default);
  app2.route("/admin/dashboard", chunkT52WOGNY_cjs.router);
  app2.route("/admin/collections", chunkT52WOGNY_cjs.adminCollectionsRoutes);
  app2.route("/admin/forms", chunkT52WOGNY_cjs.adminFormsRoutes);
  app2.route("/admin/settings", chunkT52WOGNY_cjs.adminSettingsRoutes);
  app2.route("/forms", chunkT52WOGNY_cjs.public_forms_default);
  app2.route("/api/forms", chunkT52WOGNY_cjs.public_forms_default);
  app2.route("/admin/api-reference", chunkT52WOGNY_cjs.router2);
  app2.route("/admin/database-tools", createDatabaseToolsAdminRoutes());
  app2.route("/admin/seed-data", createSeedDataAdminRoutes());
  app2.route("/admin/content", chunkT52WOGNY_cjs.admin_content_default);
  app2.route("/admin/media", chunkT52WOGNY_cjs.adminMediaRoutes);
  ...
  app2.route("/admin/plugins", chunkT52WOGNY_cjs.adminPluginRoutes);
  app2.route("/admin/logs", chunkT52WOGNY_cjs.adminLogsRoutes);
  app2.route("/admin", chunkT52WOGNY_cjs.userRoutes);
  app2.route("/auth", chunkT52WOGNY_cjs.auth_default);
  app2.route("/", chunkT52WOGNY_cjs.test_cleanup_default);
...
// src/index.ts
var VERSION = chunkZ6YTQGT5_cjs.package_default.version;

Object.defineProperty(exports, "ROUTES_INFO", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.ROUTES_INFO; }
});
Object.defineProperty(exports, "adminApiRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.admin_api_default; }
});
Object.defineProperty(exports, "adminCheckboxRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.adminCheckboxRoutes; }
});
Object.defineProperty(exports, "adminCodeExamplesRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.admin_code_examples_default; }
});
Object.defineProperty(exports, "adminCollectionsRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.adminCollectionsRoutes; }
});
Object.defineProperty(exports, "adminContentRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.admin_content_default; }
});
Object.defineProperty(exports, "adminDashboardRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.router; }
});
Object.defineProperty(exports, "adminDesignRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.adminDesignRoutes; }
});
Object.defineProperty(exports, "adminLogsRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.adminLogsRoutes; }
});
Object.defineProperty(exports, "adminMediaRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.adminMediaRoutes; }
});
Object.defineProperty(exports, "adminPluginRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.adminPluginRoutes; }
});
Object.defineProperty(exports, "adminSettingsRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.adminSettingsRoutes; }
});
Object.defineProperty(exports, "adminTestimonialsRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.admin_testimonials_default; }
});
Object.defineProperty(exports, "adminUsersRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.userRoutes; }
});
Object.defineProperty(exports, "apiContentCrudRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.api_content_crud_default; }
});
Object.defineProperty(exports, "apiMediaRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.api_media_default; }
});
Object.defineProperty(exports, "apiRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.api_default; }
});
Object.defineProperty(exports, "apiSystemRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.api_system_default; }
});
Object.defineProperty(exports, "authRoutes", {
  enumerable: true,
  get: function () { return chunkT52WOGNY_cjs.auth_default; }
});
...
Object.defineProperty(exports, "AuthManager", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.AuthManager; }
});
Object.defineProperty(exports, "PermissionManager", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.PermissionManager; }
});
Object.defineProperty(exports, "bootstrapMiddleware", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.bootstrapMiddleware; }
});
Object.defineProperty(exports, "cacheHeaders", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.cacheHeaders; }
});
Object.defineProperty(exports, "compressionMiddleware", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.compressionMiddleware; }
});
Object.defineProperty(exports, "detailedLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.detailedLoggingMiddleware; }
});
Object.defineProperty(exports, "getActivePlugins", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.getActivePlugins; }
});
Object.defineProperty(exports, "isPluginActive", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.isPluginActive; }
});
Object.defineProperty(exports, "logActivity", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.logActivity; }
});
Object.defineProperty(exports, "loggingMiddleware", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.loggingMiddleware; }
});
Object.defineProperty(exports, "optionalAuth", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.optionalAuth; }
});
Object.defineProperty(exports, "performanceLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.performanceLoggingMiddleware; }
});
Object.defineProperty(exports, "requireActivePlugin", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.requireActivePlugin; }
});
Object.defineProperty(exports, "requireActivePlugins", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.requireActivePlugins; }
});
Object.defineProperty(exports, "requireAnyPermission", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.requireAnyPermission; }
});
Object.defineProperty(exports, "requireAuth", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.requireAuth; }
});
Object.defineProperty(exports, "requirePermission", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.requirePermission; }
});
Object.defineProperty(exports, "requireRole", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.requireRole; }
});
Object.defineProperty(exports, "securityHeaders", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.securityHeaders; }
});
Object.defineProperty(exports, "securityLoggingMiddleware", {
  enumerable: true,
  get: function () { return chunkZRCUY5U2_cjs.securityLoggingMiddleware; }
});
...
Object.defineProperty(exports, "MigrationService", {
  enumerable: true,
  get: function () { return chunkXZVAP6PR_cjs.MigrationService; }
});
...
Object.defineProperty(exports, "QueryFilterBuilder", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.QueryFilterBuilder; }
});
Object.defineProperty(exports, "SONICJS_VERSION", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.SONICJS_VERSION; }
});
Object.defineProperty(exports, "TemplateRenderer", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.TemplateRenderer; }
});
Object.defineProperty(exports, "buildQuery", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.buildQuery; }
});
Object.defineProperty(exports, "escapeHtml", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.escapeHtml; }
});
Object.defineProperty(exports, "getCoreVersion", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.getCoreVersion; }
});
Object.defineProperty(exports, "renderTemplate", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.renderTemplate; }
});
Object.defineProperty(exports, "sanitizeInput", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.sanitizeInput; }
});
Object.defineProperty(exports, "sanitizeObject", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.sanitizeObject; }
});
Object.defineProperty(exports, "templateRenderer", {
  enumerable: true,
  get: function () { return chunkZ6YTQGT5_cjs.templateRenderer; }
