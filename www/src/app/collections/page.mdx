...
seo: {
  type: 'object',
  title: 'SEO',
  objectLayout: 'nested', // 'nested' (default) or 'flat'
  collapsed: false,
  properties: {
...
By default, object groups use `objectLayout: 'nested'` and render collapsed in the admin UI. Set `collapsed: false` to expand them on load. If you use `objectLayout: 'flat'`, `collapsed` is ignored.
